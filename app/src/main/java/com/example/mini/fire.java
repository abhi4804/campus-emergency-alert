        ...
        btnsubmit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.length() <= 0 && phoneno.length() <= 0) {
                    Toast.makeText(fire.this, "Username or Number cannot be empty", Toast.LENGTH_SHORT).show();
                } else if (phoneno.length() < 10) {
                    Toast.makeText(fire.this, "Enter number of 10 digits only", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (location != null) {
                        ...
                        Uri uri = Uri.parse("smsto:" + "7349500794");
                        ...
                        Toast.makeText(fire.this, "Unable to retrieve location", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
